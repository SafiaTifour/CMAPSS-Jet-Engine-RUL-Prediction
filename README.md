...
│                         CMAPSS-Jet-Engine-RUL-Prediction and configuration for tools like black
│
...
│
└── CMAPSS-Jet-Engine-RUL-Prediction   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes CMAPSS-Jet-Engine-RUL-Prediction a Python module
    │
